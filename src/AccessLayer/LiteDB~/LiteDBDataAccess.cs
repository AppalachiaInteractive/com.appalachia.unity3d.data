...
using Appalachia.Prototype.KOC.Data.Documents;
using UltraLiteDB;

namespace Appalachia.Prototype.KOC.Data.AccessLayer
{
    public class LiteDBConnectionWrapper : DbConnectionWrapper<LiteDatabase>
    {
        internal LiteDBConnectionWrapper(string filePath, bool encrypted, int initialSizeInKB = 512) : base(
            new LiteDatabase(
                GetConnectionString(
                    filePath,
                    "direct",
