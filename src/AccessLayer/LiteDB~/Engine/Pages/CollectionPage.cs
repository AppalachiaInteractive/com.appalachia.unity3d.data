...
namespace LiteDB.Engine
{
    internal class CollectionPage : BasePage
    {
            ...
            : base(buffer)
        {
            ...
            if (this.PageType != PageType.Collection) throw DataException.InvalidPageType(PageType.Collection, this);
        ...
        public CollectionIndex InsertCollectionIndex(string name, string expr, bool unique)
        {
            ...
            if (_indexes.Count == 255 || totalLength >= P_INDEXES_COUNT) throw new DataException(0, $"This collection has no more space for new indexes");
