...
namespace LiteDB.Engine
{
    internal class SysFileJson : SystemCollection
    {
        ...
        {
            var filename = GetOption(options, "filename")?.AsString ?? throw new DataException(0, $"Collection ${this.Name} requires string as 'filename' or a document field 'filename'");
        ...
        {
            var filename = GetOption(options, "filename")?.AsString ?? throw new DataException(0, "Collection $file_json requires string as filename or a document field 'filename'");
