            ...
            where T : BasePage
        {
            ...
            lock (_header)
            {
                ...
                else
                {
                    ...
                    if (newLength > _header.Pragmas.LimitSize) throw new DataException(0, $"Maximum data file size has been reached: {FileHelper.FormatFileSize(_header.Pragmas.LimitSize)}");
