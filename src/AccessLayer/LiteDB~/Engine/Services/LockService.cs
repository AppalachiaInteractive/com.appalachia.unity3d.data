...
namespace LiteDB.Engine
{
    ...
    internal class LockService : IDisposable
    {
        ...
        public void EnterTransaction()
        {
            ...
            if (_transaction.TryEnterReadLock(_pragmas.Timeout) == false) throw DataException.LockTimeout("transaction", _pragmas.Timeout);
        }
        ...
        public void EnterLock(string collectionName)
        {
            ...
            if (Monitor.TryEnter(collection, _pragmas.Timeout) == false) throw DataException.LockTimeout("write", collectionName, _pragmas.Timeout);
        }
        ...
        {
            if (_collections.TryGetValue(collectionName, out var collection) == false) throw DataException.CollectionLockerNotFound(collectionName);
        ...
        public bool EnterExclusive()
        {
            ...
            if (_transaction.TryEnterWriteLock(_pragmas.Timeout) == false) throw DataException.LockTimeout("exclusive", _pragmas.Timeout);
