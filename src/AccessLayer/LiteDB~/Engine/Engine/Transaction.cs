...
namespace LiteDB.Engine
{
    public partial class LiteEngine
    {
        ...
        public bool BeginTrans()
        {
            ...
            if (transacion.OpenCursors.Count > 0) throw new DataException(0, "This thread contains an open cursors/query. Close cursors before Begin()");
        ...
        public bool Commit()
        {
            ...
            if (transaction != null)
            {
                ...
                if (transaction.OpenCursors.Count > 0) throw new DataException(0, "Current transaction contains open cursors. Close cursors before run Commit()");
