...
namespace LiteDB.Engine
{
    public partial class LiteEngine
    {
        ...
        public bool DropCollection(string name)
        {
            ...
            if (_locker.IsInTransaction) throw DataException.AlreadyExistsTransaction();
        ...
        public bool RenameCollection(string collection, string newName)
        {
            ...
            if (collection.Equals(newName, StringComparison.OrdinalIgnoreCase)) throw DataException.InvalidCollectionName(newName, "New name must be different from current name");
            ...
            return this.AutoTransaction(transaction =>
            {
                ...
                {
                    throw DataException.AlreadyExistsCollectionName(newName);
                }
