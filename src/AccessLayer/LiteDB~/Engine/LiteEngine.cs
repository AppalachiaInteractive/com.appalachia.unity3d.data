    ...
    public partial class LiteEngine : ILiteEngine
    {
        ...
        public LiteEngine(EngineSettings settings)
        {
            ...
            try
            {
                ...
                if (buffer[0] == 1) throw new DataException(0, "This data file is encrypted and needs a password to open");
                ...
                {
                    throw new DataException(0, $"Datafile collation '{_header.Pragmas.Collation}' is different from engine settings. Use Rebuild database to change collation.");
                }
